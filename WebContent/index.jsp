	...
	<header id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="item active">
				<div class="fill"
					style="background-image: url('img/${ProdList.get(0).prod_image1}');"></div>
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<div class="fill"
					style="background-image: url('img/${ProdList.get(1).prod_image1}');"></div>
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<div class="fill"
					style="background-image: url('img/${ProdList.get(2).prod_image1}');"></div>
				<div class="carousel-caption"></div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				<a href="productFixi.do"> <img
					...
					src="img/${ProdList.get(0).prod_image1}" alt="">
				</a>
			</div>
			<div class="col-md-4 col-sm-6">
				<a href="productElectric.do"> <img
					class="img-responsive img-portfolio img-hover"
					src="img/${ProdList.get(1).prod_image1}" alt="">
				</a>
			</div>
			<div class="col-md-4 col-sm-6">
				<a href="productHybrid.do"> <img
					class="img-responsive img-portfolio img-hover"
					src="img/${ProdList.get(2).prod_image1}" alt="">
				</a>
			</div>
		</div>
		<!-- /.row -->
