        ...
        <div class="row">
            ...
            <div class="col-md-3"><!-- <br><br><br><br><br><br> -->
                ...
                <div class="list-group">
                    ...
                    <a href="productElectric.do" class="list-group-item">전기바이크</a>
                </div>
            </div>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="img/electric/filamain2.png" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/electric/filamain1.png" alt="">
                                </div>
                            </div>la
