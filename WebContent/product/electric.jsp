...
<body>
	...
	<div class="container" style="margin-top: 130px;">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<!-- <br><br><br><br><br><br> -->
				<p class="lead">전기 바이크</p>
				<div class="list-group">
					<a href="productHybrid.do" class="list-group-item">하이브리드</a> <a
						href="productMtb.do" class="list-group-item">MTB</a> <a
						href="productFixi.do" class="list-group-item">픽시</a> <a
						href="productElectric.do" class="list-group-item">전기바이크</a>
				</div>
			</div>
						...
						<div id="carousel-example-generic" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="item active">
									<img class="slide-image" src="img/electric/filamain2.png"
										alt="">
								</div>
								<div class="item">
									<img class="slide-image" src="img/electric/filamain1.png"
										alt="">
								</div>
							</div>
							la <a class="left carousel-control"
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4>
									<a href="productElectricDetail1.do">그라니티F</a>
								</h4>
								<p>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4>
									<a href="productElectricDetail2.do">샤오미 미치사이클</a>
								</h4>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4>
									<a href="productElectricDetail3.do">알톤 자이러트론</a>
								</h4>
								<p>This is a short description. Lorem ipsum dolor sit amet,
									consectetur adipiscing elit.</p>
							</div>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4>
									<a href="productElectricDetail4.do">혼다 A7</a>
								</h4>
								<p>This is a short description. Lorem ipsum dolor sit amet,
									consectetur adipiscing elit.</p>
							</div>
							<div class="ratings">
								...
								<div id="buttons">
									<a class="btn icon-btn btn-success"
										href="/race/cartInsertAction.do?CART_PROD=19&CART_QTY=1">
										<span
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4>
									<a href="productElectricDetail5.do">필라 이볼브 26xc</a>
								</h4>
								<p>This is a short description. Lorem ipsum dolor sit amet,
									consectetur adipiscing elit.</p>
							</div>
