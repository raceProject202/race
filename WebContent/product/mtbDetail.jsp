...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <img class="img-responsive" src="img/mtb/mtb1-1.PNG" alt="">
            </div>

            <div class="col-md-4">
                <h3>Project Description</h3>
                <p>mtb2 ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum nec metus. Mauris ultricies, justo eu convallis placerat, felis enim.</p>
            ...
            <label> 가 격 : </label>
				<p>5200000 원</p>
            <div id="buttons">
            	<a class="btn icon-btn btn-success" href="/race/cartInsertAction.do?CART_PROD=6&CART_QTY=1">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-xs-6">
                <a href="#" onClick="window.open('img/electric/fila1.png', 'width=614,height=620, status=no, toolbar=no, location=no, directories=no, menubar=no, scrollbars=yes, resizable=no');">
                    <img class="img-responsive portfolio-item" src="img/mtb/mtb1-2.PNG" alt="">
                </a>
            </div>
            ...
            <div class="col-sm-3 col-xs-6">
              <a href="#" onClick="window.open('img/electric/fila2.png', 'width=614,height=620, status=no, toolbar=no, location=no, directories=no, menubar=no, scrollbars=yes, resizable=no');">
                    <img class="img-responsive portfolio-item" src="img/mtb/mtb1-3.PNG" alt="">
                </a>
            </div>
            ...
            <div class="col-sm-3 col-xs-6">
                <a href="#" onClick="window.open('img/electric/fila3.png', 'width=614,height=620, status=no, toolbar=no, location=no, directories=no, menubar=no, scrollbars=yes, resizable=no');">
                    <img class="img-responsive portfolio-item" src="img/mtb/mtb1-4.PNG" alt="">
                </a>
            </div>
