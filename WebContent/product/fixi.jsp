                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="img/fixi/fix01_01.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/fixi/fix02.png" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/fixi/fix04.png" alt="">
                                </div>
                            </div>
