                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="img/mtb/mtb1-1.PNG" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/mtb/mtb2-1.PNG" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/mtb/mtb3-1.PNG" alt="">
                                </div>
                            </div>
...
<!-- 
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="img/mtb/mtb5-1.PNG" alt="">
                            <div class="caption">
                                <h4 class="pull-right">$94.99</h4>
                                <h4><a href="productMtbDetail5.do">Fifth Product</a>
                                </h4>
                                <p>This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </div>
                            <div class="ratings">
